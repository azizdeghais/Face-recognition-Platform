...
async function deleteDocument(){
  try {
    //Connect mongoDB
  mongoose.connect('mongodb+srv://miker:miker@imagegeneratordall-e.arsxo0m.mongodb.net/?retryWrites=true&w=majority', {useNewUrlParser: true,useUnifiedTopology: true,})
    //Get current date
  const currentDate=new Date();
  const result = Image.deleteMany({date:{$lt:currentDate}})
}catch(error){
