...
app.post('/upload', upload.single('image'), async (req, res) => {
  try {
    ...
    const image = new Image({ url: result.secure_url,nom,prenom,numero,naissance,fin,debut,email,password:hashedPass});
    await image.save();

    // Return the image URL in the response
    res.json({ url: result.secure_url ,nom,prenom,numero,naissance,fin,debut,email,password:hashedPass });
  } catch (error) {
