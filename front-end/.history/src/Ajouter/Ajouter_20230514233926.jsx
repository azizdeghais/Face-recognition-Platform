...
function Ajouter() {
    return (
       ...
       <Grid container spacing={4}>
        <Grid md={6}><TextField id="outlined-basic" label="Nom" variant="outlined" /></Grid>
        <Grid md={6}><TextField id="outlined-basic" label="Prénom" variant="outlined" /></Grid>
        <Grid md={6}><TextField id="outlined-basic" label="Numéro de téléphone" variant="outlined" /></Grid>
        <Grid md={6}><TextField id="outlined-basic" label="E-Mail" variant="outlined" /></Grid>
