...
function Ajouter() {
    ...
    const handleSubmit = async (event) => {
      ...
      const handleStartTime=(event)=>{
        setStartTime(event.getDate()+event.getMonth()+event.getFullYear()+event.getHours()+event.getMinutes()+event.getSeconds());
        formData.set('debut',startTime)
        console.log(startTime)
      }
      const handleEndTime=(event)=>{
        const newParameter=event;

        setEndTime(newParameter);
        formData.set('fin',endTime)
        console.log(event)
      }
