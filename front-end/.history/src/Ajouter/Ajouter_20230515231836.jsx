    ...
    return (
       ...
       <Grid container spacing={4}>
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
         <DatePicker onChange={(e)=>{setData(data.naissance=e.value)}} name='naissance' value={value} />
       ...
       <Grid xs={12}>
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
         <DatePicker onChange={(e)=>{setData(data.debut=e.value)}} name='debut' value={value} />
        </LocalizationProvider>
        </Grid>
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
         <DatePicker onChange={(e)=>{setData(data.fin=e.value)}} name='fin' value={value} />
        </LocalizationProvider>
        </Grid>
