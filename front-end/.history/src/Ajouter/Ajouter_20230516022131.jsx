   ...
   const [hasPhoto,setHasPhoto]=useState(false);
    ...
    return (
       ...
       <Grid container spacing={4}>
        <Grid xs={6}><TextField type="text" id="nom" name='nom'  label="Nom"  /></Grid>
        <Grid xs={6}><TextField type="text" id="prenom" name='prenom'  label="Prénom"  /></Grid>
        <Grid xs={6}><TextField type="text" id="numero" name='numero' label="Numéro de téléphone"  /></Grid>
        <Grid xs={6}><TextField type="text" id="email" name='email'  label="E-Mail" /></Grid>
        <Grid xs={6}><TextField type="text" id="mot-de-passe" name='mot-de-passe'  label="Mot de passe"  /></Grid>
        <Grid xs={6}><TextField type="text" id="naissance" name='naissance' label="Date de naissance"  /></Grid>
        <Grid xs={6}><TextField type="text" id="debut" name='debut'  label="Date de debut"  /></Grid>
        <Grid xs={6}><TextField type="text" id="fin" name='fin'  label="Date de fin"  /></Grid>
       ...
       <Grid xs={12}>
        ...
        <Grid xs={6} mt={2}>
            ...
            <input name='file'  type="file"  onChange={handleImageChange} accept="image/png, image/jpeg,image/jpg" />
            </Grid>
