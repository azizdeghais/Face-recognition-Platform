...
function Ajouter() {
    ...
    const [data,setData]=useState({nom:'',prenom:'',numero:'',email:'',url:''})
    ...
    return (
       ...
       <Grid container spacing={4}>
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
         <DatePicker onChange={(e)=>{setData(data.naissance=e.target.value)}} name='naissance'  />
       ...
       <Grid xs={12}>
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
         <DatePicker onChange={(e)=>{setData(data.debut=e.target.value)}} name='debut'  />
        </LocalizationProvider>
        </Grid>
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
         <DatePicker onChange={(e)=>{setData(data.fin=e.target.value)}} name='fin' />
        </LocalizationProvider>
        </Grid>
