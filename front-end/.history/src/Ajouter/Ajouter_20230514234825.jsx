...
function Ajouter() {
    return (
       ...
       <Grid xs={12}>
        ...
        <Grid xs={6} mt={2} mb={3}><Button variant="outlined">Choisir un photo de votre PC</Button></Grid>
        <Grid xs={6}><Button variant="outlined">Prendre un photo à l instant </Button></Grid>
        </Box>
