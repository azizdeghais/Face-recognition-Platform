   ...
   const [hasPhoto,setHasPhoto]=useState(false);
    ...
    return (
       ...
       <Grid container spacing={4}>
        ...
        <Grid xs={6}><TextField onChange={handlePassChange} type='password' name='mot-de-passe' id="outlined-basic" label="Mot de passe" variant="outlined" /></Grid>
        <Grid xs={6}><TextField onChange={handleNaissanceChange} name='naissance'id="outlined-basic" label="Code d'immatriculation" variant="outlined" /></Grid>
        <Grid xs={6}>
          <FormLabel sx={{fontSize:30,color:'grey'}} >Date de début:</FormLabel>
          <DatePicker selected={startDate} onChange={(date) => {setStartDate(date);console.log(date)}} />
        </Grid>
        <Grid xs={6}>
          <FormLabel sx={{fontSize:30,color:'grey'}} >Date de fin</FormLabel>
          <DatePicker selected={startDate} onChange={(date) => {setStartDate(date);console.log(date)}} />
        </Grid>
