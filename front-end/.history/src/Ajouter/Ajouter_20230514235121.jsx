...
function Ajouter() {
    return (
       ...
       <Grid xs={12}>
        ...
        <Box>
        <Grid container>
        <Grid xs={6} mt={2}><Button variant="outlined">
            <Typography>Choisir un photo de votre PC</Typography>
            </Button></Grid>

        <Grid xs={6} mt={2}><Button variant="outlined"><Typography>Prendre un photo à l instant</Typography></Button></Grid>
        </Grid>
        </Box>
