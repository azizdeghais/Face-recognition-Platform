        ...
        <TableBody>
          {data? (data.map((row) => (
            ...
            >
              ...
              <TableCell><Button onClick={()=>handleDelete(row._id)} value={row._id} align='right'  sx={{mb:2}} variant='contained' color='error'>Supprimer</Button><br /><Button onClick={()=>handleDelete(row._id)} value={row._id} align='right' fullWidth={true} variant='contained' color='success'>Modifier</Button></TableCell>
            </TableRow>)
