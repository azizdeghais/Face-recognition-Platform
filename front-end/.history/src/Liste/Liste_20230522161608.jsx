        ...
        <TableBody>
          {data? (data.map((row) => (
            ...
            >
              ...
              <TableCell><Button onClick={()=>handleDelete(row._id)} value={row._id} sx={{mb:1,width:20}}  variant='contained' color='inherit'><img src={'../../public/delete.png'}></img></Button><br />
              <Button onClick={()=>handleDelete(row._id)} value={row._id}  sx={{width:100}} variant='contained' color='success'><img width={20} src={'../../public/edit.png'}></img></Button></TableCell>
            </TableRow>)
