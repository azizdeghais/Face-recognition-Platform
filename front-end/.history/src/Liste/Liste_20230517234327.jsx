...
export default function Ajouter() {
  ...
  const handleDelete=async(e)=>{
    ...
    await axios.delete(`http://localhost:3000/${id}`).then((res)=>console.log(res));
  }
        ...
        <TableBody>
          {data? (data.map((row) => (
            ...
            >
              ...
              <TableCell><Button onClick={handleDelete} value={row._id} align='right' fullWidth={true} variant='contained' color='error'>Supprimer</Button></TableCell>
            </TableRow>)
