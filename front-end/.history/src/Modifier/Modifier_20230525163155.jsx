...
<Grid xs={6}><TextField onChange={handlePrenomChange} name='prenom'   variant="outlined" /></Grid>
<Grid xs={6}><TextField onChange={handleNumeroChange} name='numero'  variant="outlined" /></Grid>
<Grid xs={6}><TextField onChange={handleEmailChange} name='email'  variant="outlined" /></Grid>
<Grid xs={6}><TextField onChange={handlePassChange} type='password' name='password' variant="outlined" /></Grid>
<Grid xs={6}><TextField onChange={handleNaissanceChange} name='naissance'  variant="outlined" /></Grid>
<Grid xs={6} >
