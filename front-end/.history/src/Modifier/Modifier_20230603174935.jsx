    ...
    const handleFormSubmit = async (event) => {
      ...
      const handleStartTime = (event) => {
        ...
        if (selectedDateTime.isValid()) {
          const formattedDateTime = selectedDateTime.tz('Europe/Berlin').toISOString();
          console.log(selectedDateTime.toDate())
          setStartTime(selectedDateTime.toDate());
          formData.set('debut', selectedDateTime.toDate());
        } else {
          setStartTime(event);
        }
      };
      ...
      const handleEndTime = (event) => {
        ...
        if (selectedDateTime.isValid()) {
          const formattedDateTime = selectedDateTime.tz('Europe/Berlin').toISOString();
          setEndTime(selectedDateTime.toDate());
          formData.set('fin', selectedDateTime.toDate());
        } else {
          setEndTime(event);
        }
      };
