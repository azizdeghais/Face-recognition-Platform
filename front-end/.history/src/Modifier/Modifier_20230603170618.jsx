   ...
   const blob = new Blob([new Uint8Array(byteArrays)], { type: 'image/jpeg' });
    ...
    const handleFormSubmit = async (event) => {
      ...
      const handleStartTime = (event) => {
        ...
        console.log(selectedDateTime.utcOffset());
      ...
      const handleEndTime = (event) => {
        ...
        const selectedDateTime = moment(event).tz('Europe/Germany');
        console.log(selectedDateTime.utcOffset());
...
showTimeSelect
dateFormat="Pp"
value={moment(startTime).tz('Europe/Berlin').toDate()}/>
</Grid>      
<Grid xs={6} >
...
showTimeSelect
dateFormat="Pp"
value={moment(endTime).tz('Europe/Berlin').toDate()}/>
</Grid>   
</Grid>
<Box>
<Grid container>
