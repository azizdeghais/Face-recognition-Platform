    ...
    const handleFormSubmit = async (event) => {
      ...
      const handleStartTime = (event) => {
        ...
        if (selectedDateTime.isValid()) {
          const offset = selectedDateTime.utcOffset();
          const formattedDateTime = selectedDateTime.format(`YYYY-MM-DDTHH:mm:ss.SSS${getOffsetString(offset)}`);
      ...
      // Helper function to format the offset string
