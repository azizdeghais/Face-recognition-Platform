        ...
        <TableBody>
          {data? (data.map((row) => (
            ...
            >
              ...
              <TableCell align="right">{row.image_path?  (<img   style={{ width: 100, height: 100 }} src={`${row.image_path}`} />):(<img src='https://cdn.discordapp.com/attachments/902316814502080522/1116144261965025300/ok.png' width={50} height={50} />)}</TableCell>
            </TableRow>)
